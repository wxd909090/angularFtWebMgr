app
.controller('storeStatisticController',function ($scope,$timeout,$localStorage,$uibModal,Auth,SweetAlert,StoreList,StoreStream,StoreStatistic) {
    ...
    function bigBusinessStatistics(data){
        StoreStatistic.bigBusinessStatistics(data).then(function(response){
            if(response.code  == 0){
    ...
    $scope.getSettleRecord = function (data){
        StoreStatistic.getSettleRecord(data).then(function(response){
            if(response.code  == 0){
    ...
    $scope.clickRecordStatistic = function(storeName,storeSn){
        var modalInstance = $uibModal.open({
            ...
            controller: 'recordModalInstanceCtrl',
            resolve: {
                storeSn:function () {
                    return storeSn;
                },
...
//营业统计
app.controller('saleModalInstanceCtrl',function ($scope,$localStorage,$uibModalInstance,apiUrl,StoreStream,storeSn,storeName,SweetAlert,StoreStatistic) {
    //>>>默认参数设置
    ...
    function storeBusinessStatistics(data) {
        ...
        StoreStatistic.storeBusinessStatistics(data).then( function (response){
            if(response.code == 0){
    ...
    function getSettleSummary(data){
        StoreStatistic.getSettleSummary(data).then( function (response){
            if(response.code == 0){
    ...
    function exportStatistic(data){
        StoreStatistic.exportSaleStatistic(data).then( function (response){
            if(response.code == 0){
...
//包间统计
app.controller('roomModalInstanceCtrl',function ($scope,$localStorage,$uibModalInstance,apiUrl,StoreStream,storeSn,storeName,SweetAlert,StoreStatistic) {
    //>>>默认参数设置
    ...
    function privateRoomBusinessStatistics(data){
        StoreStatistic.privateRoomBusinessStatistics(data).then( function (response){
            if(response.code == 0){
...
//消费统计
app.controller('recordModalInstanceCtrl',function ($scope,$localStorage,$uibModalInstance,StoreStream,storeSn,storeName,SweetAlert,StoreStatistic) {
    //>>>默认参数设置
    $scope.storeName = storeName;
    $scope.storeSn = storeSn;
    //消费记录
    ...
    function getOrderRecords(data){
        StoreStatistic.getOrderRecords(data).then( function (response){
            if(response.code == 0){
...
//结算
app.controller('settleModalInstanceCtrl',function ($scope,$localStorage,$uibModalInstance,StoreStream,storeSn,storeName,SweetAlert,StoreStatistic,storeStatisticController) {
    //>>>默认参数设置
    $scope.storeName = storeName;
    $scope.storeSn = storeSn;
    //结算
    ...
    function getSettlePrice(data){
        StoreStatistic.getSettlePrice(data).then( function (response){
            if(response.code == 0){
    ...
    function addSettleRecords(data){
        StoreStatistic.addSettleRecords(data).then( function (response){
            if(response.code == 0){
               $scope.allTotalMoney = response.data;
               $scope.price = $scope.allTotalMoney.price;
               $scope.settleCharge = $scope.allTotalMoney.settleCharge;
